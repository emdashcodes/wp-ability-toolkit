...
function register_think_ability() {
	wp_register_ability(
		...
		array(
			...
			'description'         => __( 'Use this tool to think about something. It will not obtain new information or change the database, but just append the thought to the log. Use it when complex reasoning or some cache memory is needed.', 'wp-ability-toolkit' ),
			'category'            => 'meta-tools',
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(
